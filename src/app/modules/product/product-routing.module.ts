...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: ':partId/view', component: ProductViewComponent, resolve: { company: () => inject(CompanyService).companyResolverFn() }, canActivate: [canActivate], title: companyNameResolverFn },
